...
def main(args: argparse.Namespace) -> float:
    ...
    kf = sklearn.model_selection.StratifiedKFold(5).split(train_data, train_target)
    
    model = sklearn.model_selection.GridSearchCV(estimator=pipe, param_grid=parameters,cv=kf).fit(train_data, train_target)
